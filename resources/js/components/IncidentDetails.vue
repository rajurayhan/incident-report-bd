      ...
      <div class="mb-6">
        ...
        <div v-if="isAuthenticated" class="mb-4 p-4 bg-gray-50 rounded-lg">
          ...
          <textarea
            ...
            :placeholder="getAddCommentPlaceholder()"
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
              <h4 class="text-lg font-medium text-blue-900 mb-2">
                {{ $t('commentLogin.title') }}
              </h4>
              <p class="text-blue-700 mb-4">
                {{ $t('commentLogin.message') }}
              </p>
...
const getAddCommentPlaceholder = () => {
  return 'Add a comment... (Use @ to mention users)'
}
